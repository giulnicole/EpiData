...
- unmethylated counts matrix (Unmet_matrix)
...
`#TODO:` How do we define outliers here? Please provide a small description as you did in "Cleaning step 1"
...
`#TODO:` You mention about the `imputeCorr` below, but we haven't used that function. Users will get confused. 
...
#TODO: measureAccuracy() does not need to make plots. 
#TODO: Let's have a separate function for plotting, instead of letting measureAccuracy() to do that
measure_imp_m$Boxplot.rmse
measure_imp_m$Boxplot.mae


#TODO: FURTHER IMPORTANT POINTS:
#TODO: 1) PARALLELIZATION: Do we have a strategy for parallel processing? We will need parallelization for big datasets. 
#TODO: 2) END RESULTS    : The user approched until here and we still do not have final "imputed" methylated/unmethylated/coverage matrices. 
#TODO:                   : We need to make it more convenient for the user.
