...
A comparison can be performed on an experimental dataset from a subset of CpGs which have much complete data.   
```{r, message=FALSE, warning=FALSE}
