...
```{r}
assays<- assays(rangedObject)
coverage<- assays@listData[["Coverage_matrix"]]
met <-assays@listData[["Met_matrix"]]
unmet <- assays@listData[["Unmet_matrix"]]

input.list <-  list(Coverage_matrix=coverage, Met_matrix=met, Unmet_matrix=unmet)
