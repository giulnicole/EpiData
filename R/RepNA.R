...
#'   \item{imputed}{list of imputed datasets across replications}
#'   \item{RMSE}{numeric vector of RMSE values}
#'   \item{MAE}{numeric vector of MAE values}
#'   \item{KS_statistics}{KS test results}
#'   \item{Comp_time}{computation time (if recorded)}
#'
#' @examples
#'  \dontrun{
#'
