#'
#' @description
#' \code{\link{clean_matrix_cov}} helps in the conversion of missing values (0->NA) in the coverage matrix,
...
which_matrix <- function(list.cleaned) {
...
clean_matrix_cov <- function(X, Y, Z, max_na_cpg=0.5, max_na_ind=0.2, cpg_removal_threshold=10) {
