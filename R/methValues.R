#' @title methValues
#' @description
#' \code{\link{methValues}} is a function which computes the Beta and M matrices from the filtered filtered coverage, methylated and unmethylated counts.
#'
#'
...
#'
#'
methValues <- function(filtered.obj){
