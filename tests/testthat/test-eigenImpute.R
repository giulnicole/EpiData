...
# Define a test case
test_that("eigenImpute imputes missing values based on correlation with parallelization", {
  ...
  result0 <- missingStats(list.cleaned)
  result <- eigenImpute(list.stats = result0)
